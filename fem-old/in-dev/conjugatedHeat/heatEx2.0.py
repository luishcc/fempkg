...
for i in range(len(malha_fldH.dirichlet_points)):
    index = int(malha_fldH.dirichlet_points[i][0]-1)
    if y_fldH[index] != 0.20000000298 and y_fldH[index] != 0.300000011921 and y_fldH[index] != 0.10000000149 and y_fldH[index] != 0.0:
        print y_fldH[index], " - boundary problem index: ", index, "/", len(malha_fldH.dirichlet_points)
        count += 1
print "Total problems: ", count
...
for i in range(nodes_total):
    if y_total[i] < 0.1 or y_total[i] > 0.2:
...
lista = []
for i in range(nodes_fldH):
    if x_fldH[i] == 0.0 or y_fldH[i] == 0.20000000298 or y_fldH[i] == 0.300000011921\
            or x_fldH[i] == 1.0 or y_fldH[i] == 0.10000000149 or y_fldH[i] == 0.0:
...
for i in Fluid_Boundary_h:
    j = int(i)
    vy_h[j] = 0.0
    if x_fldH[j] == 0.0 and (0.2 <= y_fldH[j] <= 0.3):
        vx_h[j] = 0.2
    if x_fldH[j] == 1.0 and (0.0 <= y_fldH[j] <= 0.1):
        vx_h[j] = -0.1
    if y_fldH[j] == 0.20000000298 or y_fldH[j] == 0.300000011921 or y_fldH[j] == 0.10000000149 or y_fldH[j] == 0.0:
        vx_h[j] = 0.0
# --------------------------------------
