...
for i in range(nodes):
    if x[i] == 0.0 or y[i] == 0.0 or y[i] == 1.0 or x[i] == 8. \
or (y[i] == 0.9 and ((0.5 < x[i] < 1.0) or (1.5 < x[i] < 2.0) or (2.5 < x[i] < 3.0) or (3.5 < x[i] < 4.0) or (4.5 < x[i] < 5.0))) \
or (y[i] == 0.1 and ((0.5 < x[i] < 1.0) or (1.5 < x[i] < 2.0) or (2.5 < x[i] < 3.0) or (3.5 < x[i] < 4.0) or (4.5 < x[i] < 5.0))):
        Boundary[i] = i
...
for n in Boundary:
    ...
    if x[j] == 0.0 :
        vx[j] = 1.0
    if y[j] == 1.0 or (y[i] == 0.9 and ((0.5 < x[i] < 1.0) or (1.5 < x[i] < 2.0) or (2.5 < x[i] < 3.0) or (3.5 < x[i] < 4.0) \
                                          or (4.5 < x[i] < 5.0))) \
             or (y[i] == 0.1 and ((0.5 < x[i] < 1.0) or (1.5 < x[i] < 2.0) or (2.5 < x[i] < 3.0) or (3.5 < x[i] < 4.0) \
                                          or (4.5 < x[i] < 5.0))):
        psi_dirichlet[j] = 1.0
        vx[j] = 0.0
    if y[j] == 0.0:
...
for t in range(0, tempo-1):
    ...
    for i in range(dir_gmsh):
        ...
        value = (-15. / 48. + 2. * (malha.X[index]) + 1.5 * (malha.Y[index] - 0.5) ** 2 - (malha.Y[index] - 0.5) ** 4)
    ...
    for i in range(dir_gmsh):
        index = int(malha.dirichlet_points[i][0]) - 1
        F_temp[index] = (-15./48. + 2*(malha.X[index]) + 1.5*(malha.Y[index]-0.5)**2-(malha.Y[index]-0.5)**4)
