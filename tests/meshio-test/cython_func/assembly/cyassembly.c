...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cyassembly",
        "sources": [
            "/home/luis/fempkg/tests/meshio-test/cython_func/assembly/cyassembly.pyx"
        ]
    },
 ...
 */
  ...
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_v__ien, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_11 = __Pyx_PyInt_From_int((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v__ien.data + __pyx_t_9 * __pyx_v__ien.strides[0]) ) + __pyx_t_10 * __pyx_v__ien.strides[1]) )))); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 38, __pyx_L1_error)
